...
class Series(models.Model):
    ...
    series_name = models.CharField(db_column='series_name', max_length=100, blank=True, null=True)
    series_image = models.ImageField(db_column='series_image', upload_to='series_logos/', blank=True, null=True)
