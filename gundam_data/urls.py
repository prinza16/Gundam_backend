...
from .views import TypesListCreateAPIView, TypeRetrieveUpdateDestroyAPIView, SellerListCreateAPIView, SellerRetrieveUpdateDestroyAPIView, ModelDataListCreateAPIView, ModelDataRetrieveUpdateDestroyAPIView, ModelPilotAssignmentListCreateAPIView, ModelSeriesOccurrenceListCreateAPIView, ModelImageListCreateAPIView
...
urlpatterns = [
    ...
    path('images/', ModelImageListCreateAPIView.as_view(), name='modelimage-list-create'),
