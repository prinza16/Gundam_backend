    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_length', models.CharField(blank=True, db_column='model_length', max_length=50, null=True)),
                ('model_width', models.CharField(blank=True, db_column='model_width', max_length=50, null=True)),
                ('model_height', models.CharField(blank=True, db_column='model_height', max_length=50, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
